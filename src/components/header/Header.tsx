...
export default function Header() {
    return(
        <main className="flex items-center justify-between h-[100px] px-4">
            ...
            <button className=" outline-none box-border cursor-pointer text-orange-600 border-solid border-2 border-orange-600 py-3 px-8 rounded-3xl mr-8 hover:bg-orange-600 hover:text-white">My Channel</button>
